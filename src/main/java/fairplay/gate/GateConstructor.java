...
public class GateConstructor {
	...
	public GateConstructor(String s, InputGateType type) {
	...
	public GateConstructor(int numberOfInputWires, int numberOfOutputWires, int leftWireIndex, int rightWireIndex, int outputWireIndex, String boolTable) {
